...
describe('users', () => {
  ...
  test('a valid user can be added', async () => {
    const newUser = { username: 'newuser', name: 'New User', password: 'test123' }
  ...
  test('user without username is not added', async () => {
    const newUser = { name: 'New User', password: 'test123' }
  ...
  test('user is not added if password length is 2 characters', async () => {
    const newUser = { username: 'newuser', name: 'New User', password: 'pw' }
  ...
  test('user is not added if username length is 2 characters', async () => {
    const newUser = { username: 'nu', name: 'New User', password: 'password' }
