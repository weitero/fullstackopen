...
const testUser = { name: 'Test User', username: 'testuser', password: 'password123' }
...
describe('when there are initially some blogs saved', () => {
  ...
  describe('when adding a new blog', () => {
    ...
    test('posting a blog without title causes response 400', async () => {
      const newBlog = { author: 'Mark Markkanen', url: 'https://testurl.com/', likes: 5 }
    ...
    test('posting a blog without url causes response 400', async () => {
      const newBlog = { title: 'Testing Blog API', author: 'Mark Markkanen', likes: 5 }
